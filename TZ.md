...
*   **Гость**: Любой посетитель сайта. Может ввести публичную ссылку на Steam-профиль для анализа.
*   **Анализируемый пользователь**: Пользователь Steam, чей профиль был введен в систему. Для него и его друзей будет построена статистика. Система не требует отдельной регистрации; "пользователем" становится тот, чей профиль анализируется в данный момент.
